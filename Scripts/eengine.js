...
var ee = {
    ...
    setOnClick: function (div, func) {
        div.eeOnClick = func;
        if (div.eeMouseEvent) return;
        div.eeMouseEvent = true;
...
var eb = {
    ...
    initButton: function (div) {
        ...
        if (eb.isEmpty(div.initialized)) {
            ...
            //"    eb.setAni(e.status1, \"disappear\", \"null\", \"null\", 0, true, true);\n" +
            //"    ee.showAni(e.status1);\n" +
                ...
                "         if (eb.isEmpty(e)) return;\n" +
                "    }\n" +
            //"    eb.setAni(e.status1, \"appear\", \"null\", \"null\", 0, true, false);\n" +
            //"    ee.showAni(e.status1);\n" +
